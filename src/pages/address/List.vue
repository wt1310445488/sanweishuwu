...
export default {
    ...
    methods:{
        loadData(){
             let url = "http://120.55.194.134:6677/address/findAll"
        ...
        submitHandler(){
            ...
            let url = "http://120.55.194.134:6677/address/saveOrUpdate"
            request({
                url,
                method:"POST",
                headers:{
        ...
        toDeleteHandler(id){
          ...
          type: 'warning'
            ...
            //调用后台接口，完成删除操作。
            let url = "http://120.55.194.134:6677/address/deleteById?id="+id;
            request.get(url).then((response)=>{
                //1.刷新数据
                this.loadData();
                //2.提示结果
